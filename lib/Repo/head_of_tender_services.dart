...
class HeadOfTenderServices{
  ...
  userLogin(String email,String password) async {
    ...
    bool passwordExists;
    try {
      var authResult = await _firestore.collection(FirestoreConstants.headOfTenderCollection)
      ...
      if (userNameExists) {
        var authResult = await FirebaseFirestore.instance
            .collection(FirestoreConstants.headOfTenderCollection)
